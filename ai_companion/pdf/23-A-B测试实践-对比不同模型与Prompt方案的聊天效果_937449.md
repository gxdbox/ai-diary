...
<audio controls src="audio/23-A-B测试实践_937449_3626068167.mp3"></audio>
...
评估指标你可以参考表23-1。
<img src="image/23-A-B测试实践_937449_43e8cfda2e.jpg" alt="" title="表 23-1 大模型评估指标" loading="eager" decoding="sync" referrerpolicy="no-referrer"/>

结果分析

7天后，数据如表23-2所示。
<img src="image/23-A-B测试实践_937449_eb53b4c903.jpg" alt="" title="表 23-2 结果分析" loading="eager" decoding="sync" referrerpolicy="no-referrer"/>
...
enjoylearning · 2026-01-05 00:41:44 · 点赞 1

方法论很全面，只不过某些指标似乎理想化了，但这样的产品着实不太容易从用户的角度获取到客观数据，想到的另外方法可能是让模型来评价模型

讨论串（2）

讨论 #1

袁从德 · 2026-01-05 16:53:17 · 点赞 0

感谢你的深度思考！确实，情感类产品的评估指标（如"被理解感"、"温暖感"）存在主观性强、难以量化的挑战。可以通过用户行为指标进行判断，例如用户时长、聊天次数、话题深度指标进行判断。从我之前在腾讯和阿里做推荐的经验看，用户直接说推的很准这很难，但可以通过互动指标、时长指标、加购指标的推出用户是否满意。

讨论 #2

enjoylearning · 2026-01-05 21:23:15 · 点赞 0

推荐还好说，比如用户按照推荐的买了，或去看了推荐的广告。

评论 #2

拖鞋小老弟~~ · 2026-01-02 07:58:28 · 点赞 0

老师请问，这块的打分机制的“分” 的设计规则是如何设计的呢

讨论串（1）

讨论 #1

袁从德 · 2026-01-07 11:58:23 · 点赞 0

好问题！在"心语"的A/B测试中，我们采用1-5分制评分：1分=完全不满意，2分=不满意，3分=基本合格，4分=良好，5分=非常满意。评分维度包括总体评分、共情度、自然度和安全性，实践中≥4分视为"满意"。设计原则是简单易用（3秒内完成）、保持一致性（所有实验组使用相同标准）。文档中提到的"实用性"和"温暖感"可作为情感陪伴场景的特化补充维度，关键是保持评分标准的一致性，确保A/B测试结果可信。
